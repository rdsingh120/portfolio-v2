...
const GitHubStats = () => {
  ...
  return (
    <a
      ...
      className="mb-2 bg-[#151b23] border border-[#fff] rounded-xl py-2 w-full flex flex-nowrap md:flex-wrap lg:flex-nowrap justify-center gap-0 md:gap-2 lg:gap-0  p-2"
    >
